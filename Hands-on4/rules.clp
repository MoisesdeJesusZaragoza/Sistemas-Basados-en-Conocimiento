...
=>
    (if (member$ 1 ?smartphone-ids) 
	     ...
	     (printout t "!!! 1. NO INTERESTS: ORDER #"
			 ?id " !!!" crlf
			 "For buying an iPhone 16 with a Banamex card you have: 24 months without interests." 
			 crlf crlf)))
...
=>
    (if (member$ 2 ?smartphone-ids) 
	     ...
	     (printout t "!!! 2. NO INTERESTS: ORDER #"
			 ?id " !!!" crlf
			 "For buying a Samsung Note 21 with a Liverpool VISA card you have: 12 months without interests." 
			 crlf crlf)))
...
=>
    (if (and (member$ 2 ?smartphone-ids) (member$ 5 ?computer-ids)) 
	     ...
	     (printout t "!!! 10. VOUCHER: ORDER #"
			 ?id " !!!" crlf
			 "For buying an Asus ROG Zephyrus G14 and a Samsung Note 21 you have: 200 pesos in vouchers for every 1000 pesos spent." 
			 crlf crlf)))
...
=>
    (if (and (member$ 2 ?smartphone-ids) (member$ 4 ?smartphone-ids)) 
	     ...
	     (printout t "!!! 13. VOUCHERS: ORDER #"
			 ?id " !!!" crlf
			 "For buying a Samsung Note 21 and a OnePlus 9 you have: 50 pesos in vouchers for every 1000 pesos spent." 
			 crlf crlf)))
